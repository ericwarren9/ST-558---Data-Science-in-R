...
```{r dplyr image, echo=FALSE, out.width="25%", fig.align='center'}
...
```{r ggplot2 image, echo=FALSE, out.width="25%", fig.align='center'}
...
```{r readr image, echo=FALSE, out.width="25%", fig.align='center'}
...
```{r tidyr image, echo=FALSE, out.width="25%", fig.align='center'}
