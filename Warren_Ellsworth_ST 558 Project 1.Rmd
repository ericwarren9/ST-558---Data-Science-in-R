...
Now we are going to select the following columns in order to trim the data we are analyzing. The columns we are using have at least one of the following characteristics:
