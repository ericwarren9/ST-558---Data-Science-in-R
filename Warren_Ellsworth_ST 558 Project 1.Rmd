...
We are going to call the function we have made two times to read in and parse the two .csv files that have been mentioned so far. Be sure to call the new value column the same in both function calls.